  ...
  function l() {
      ...
      if (
        ...
        '0' != o.albumID && u.O.thumbnailLevelUp && c--,
          c > 0
                            ...
                            t.tween({
                              ...
                              finish: function (t) {
                                null != u.GOM.slider.hostItem.$getElt() &&
                                  ...
                                  (N(u.GOM.NGY2Item(u.GOM.slider.nextIdx)),
            ...
            : (N(u.GOM.slider.hostItem), (u.GOM.slider.hostIdx = -1)),
    ...
    function Le() {
      u.VOM.zoom.isZooming || (u.VOM.zoom.userFactor = 1),
        Ce(u.VOM.content.current, !0),
        Ce(u.VOM.content.previous, !1),
        Ce(u.VOM.content.next, !1);
    }
    function Ee(e) {
                  ...
                  ? (u.VOM.hammertime.add(
                    ...
                    u.VOM.hammertime.on('singletap', function (e) {
                      if (Ve()) {
                        ...
                        if ((Ne(e.srcEvent), 0 == u.VOM.toolbarsDisplayed))
                          s(Ae, 100, !1)(),
                            (u.VOM.singletapTime = new Date().getTime());
                        else {
    ...
    function Re() {
      u.VOM.$viewer.off('touchstart click', '.ngy2viewerToolAction', _e),
        u.VOM.$viewer.on('touchstart click', '.ngy2viewerToolAction', _e);
    }
    function _e(t) {
        ...
        if (null != i) {
          switch (i) {
            ...
            case 'info':
              ...
              break;
            case 'close':
              if ((Ne(t), new Date().getTime() - u.VOM.timeImgChanged < 400))
                return;
              tt();
              break;
            case 'download':
    ...
    function it(e) {
      const t = /(auto|scroll)/,
        ...
        a = (e) =>
          t.test(
            ((e) => i(e, 'overflow') + i(e, 'overflow-y') + i(e, 'overflow-x'))(
              e
            )
          );
      return ((e) => {
      ...
      Y.prototype = {
        ...
        init: function () {
          this.evEl && y(this.element, this.evEl, this.domHandler),
            ...
            this.evWin && y(C(this.element), this.evWin, this.domHandler);
        },
        destroy: function () {
